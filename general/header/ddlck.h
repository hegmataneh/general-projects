...
#define DD_MAX_FILE 4 /*according to app c files*/ /*TODO*/
#define DD_LINE_COUNT 1700 /*your app c file max lines count*/
...
//#define USE_SOURCE_IN_DDLCK /*define this in source file that you want to track lock in them*/

#ifndef IN_DDLCK_H // in other source they prepare prerequisit /*TODO*/
#ifdef USE_SOURCE_IN_DDLCK
	DD_EACH_FILE_INIT;
#endif
#endif
...
#define LOCK_LINE( exp /*put lockable line in this macro*/ )	({ \
							...
							ulong iii = tmp_ddl % SEQ_TRACE_COUNTE/*first % then ++*/; \
							__lck_lines_hit[ iii ][0]++; \
							__lck_lines_hit[ iii ][1] = tmp_ddl; \
							__lck_lines_hit[ iii ][2] = (ulong)(const char *)__FUNCTION__; \
...
#define BP_LOCK_LINE( exp )			NO_LOCK_LINE( exp )
#define DEFRG_LOCK_LINE( exp )		NO_LOCK_LINE( exp )
